...
В качестве источников телеметрии выступали как сама GoPro (да, к 4у году обладания это камерой я вдруг узнал что она тоже пишет телеметрию), так и наш RPI (для данных, которыми не обладает GoPro). Вот список показателей и источники:
...
58mbar. Почти втрое выше, чем у Vostok-3b и все еще экстремально низно для людей :)
